...
export default function TextTestFrame() {
	return (
		<div className="p-5 font-sans max-w-4xl">
			...
			<section className="mb-8">
				...
				<p data-testid="paragraph-3">
					...
					<code data-testid="inline-code" className="bg-gray-100 px-1 rounded">
						inline code
					</code>{" "}
					and a{" "}
					<a
				...
				>
					...
					<tbody>
						<tr data-testid="table-row-1">
							...
							<td className="p-2.5 border border-gray-300">john@example.com</td>
						...
						<tr data-testid="table-row-2">
							...
							<td className="p-2.5 border border-gray-300">jane@example.com</td>
						...
						<tr data-testid="table-row-3">
							...
							<td className="p-2.5 border border-gray-300">bob@example.com</td>
